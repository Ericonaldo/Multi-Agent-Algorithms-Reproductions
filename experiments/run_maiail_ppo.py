...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_name", type=str, default="maiail-ppo", help="name of the experiment")
    ...
    for iteration in range(iterations):
        ...
        if not is_evaluate:
            ...
            for i in range(num_agents):
                x = dm[i].transform(learning_dataset.observations[i], learning_dataset.actions[i])
                agent_pdf[i].fit(x) 
            ...
            t_info = maiail.train(expert_dataset, learning_dataset, expert_pdf, agent_pdf, dm) # TODO dimensioner not implement
