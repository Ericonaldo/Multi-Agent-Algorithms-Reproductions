...
if __name__ == '__main__':
    ...
    parser.add_argument("--sample_episodes", type=int, default=50, help="number of sampling episodes")
    ...
    parser.add_argument("--exp_name", type=str, default="maiail_maddpg", help="name of the experiment")
